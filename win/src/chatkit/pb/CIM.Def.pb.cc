...
static ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<std::string> CIMCmdID_strings[44] = {};
...
static const ::PROTOBUF_NAMESPACE_ID::internal::EnumEntry CIMCmdID_entries[] = {
  ...
  { {CIMCmdID_names + 744, 29}, 257 },
  { {CIMCmdID_names + 773, 29}, 258 },
  { {CIMCmdID_names + 802, 24}, 261 },
  { {CIMCmdID_names + 826, 17}, 769 },
  { {CIMCmdID_names + 843, 21}, 770 },
  { {CIMCmdID_names + 864, 30}, 775 },
  { {CIMCmdID_names + 894, 30}, 776 },
  { {CIMCmdID_names + 924, 34}, 773 },
  { {CIMCmdID_names + 958, 34}, 774 },
  { {CIMCmdID_names + 992, 21}, 771 },
  { {CIMCmdID_names + 1013, 24}, 772 },
  { {CIMCmdID_names + 1037, 16}, 0 },
  { {CIMCmdID_names + 1053, 24}, 1031 },
  { {CIMCmdID_names + 1077, 21}, 1029 },
  { {CIMCmdID_names + 1098, 21}, 1030 },
  { {CIMCmdID_names + 1119, 23}, 1028 },
  { {CIMCmdID_names + 1142, 26}, 1026 },
  { {CIMCmdID_names + 1168, 30}, 1027 },
  { {CIMCmdID_names + 1198, 24}, 1025 },
};

static const int CIMCmdID_entries_by_number[] = {
  36, // 0 -> kCIM_CID_UNKNOWN
  25, // 257 -> kCIM_CID_LOGIN_AUTH_TOKEN_REQ
  26, // 258 -> kCIM_CID_LOGIN_AUTH_TOKEN_RSP
  23, // 259 -> kCIM_CID_LOGIN_AUTH_LOGOUT_REQ
  24, // 260 -> kCIM_CID_LOGIN_AUTH_LOGOUT_RSP
  27, // 261 -> kCIM_CID_LOGIN_HEARTBEAT
  ...
  28, // 769 -> kCIM_CID_MSG_DATA
  29, // 770 -> kCIM_CID_MSG_DATA_ACK
  34, // 771 -> kCIM_CID_MSG_READ_ACK
  35, // 772 -> kCIM_CID_MSG_READ_NOTIFY
  32, // 773 -> kCIM_CID_MSG_GET_LATEST_MSG_ID_REQ
  33, // 774 -> kCIM_CID_MSG_GET_LATEST_MSG_ID_RSP
  30, // 775 -> kCIM_CID_MSG_GET_BY_MSG_ID_REQ
  31, // 776 -> kCIM_CID_MSG_GET_BY_MSG_ID_RSP
  43, // 1025 -> kCIM_CID_VOIP_INVITE_REQ
  41, // 1026 -> kCIM_CID_VOIP_INVITE_REPLY
  42, // 1027 -> kCIM_CID_VOIP_INVITE_REPLY_ACK
  40, // 1028 -> kCIM_CID_VOIP_HEARTBEAT
  38, // 1029 -> kCIM_CID_VOIP_BYE_REQ
  39, // 1030 -> kCIM_CID_VOIP_BYE_RSP
  37, // 1031 -> kCIM_CID_VOIP_BYE_NOTIFY
...
bool CIMCmdID_Parse(
  ...
  bool success = ::PROTOBUF_NAMESPACE_ID::internal::LookUpEnumValue(
      CIMCmdID_entries, 44, name, &int_value);
  if (success) {
...
CIMUserInfo::CIMUserInfo(const CIMUserInfo& from)
  ...
  if (!from._internal_nick_name_spell().empty()) {
    nick_name_spell_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_nick_name_spell(),
      GetArena());
  }
